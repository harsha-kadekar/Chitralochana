##############################################################################################################################
# Name: languageprocessing.py
# Description: This file will hold functions and classes that deal with natural language processing.
...
class LanguageProcessor(object):
    ...
    @staticmethod
    def Get_Common_Words_Tweets(Msg_List, max_words_count):
        '''
        ...
        return count_all.most_common(max_words_count)
