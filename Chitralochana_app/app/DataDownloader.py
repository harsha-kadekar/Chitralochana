...
import thread
import globalvars
from twitter import metamodelBuilding
...
def twitterdownloadInitiator(user_sentence):
    ...
    globalvars.tweetThread = thread.start_new_thread(GetPastTweets, (imp_words, ))
    ...
    for searchString in searchStrings:
        ...
        for tweet in searchTweets:
            ...
            if globalvars.metamodelThread is None:
                globalvars.metamodelThread = thread.start_new_thread(metamodelBuilding, ())
